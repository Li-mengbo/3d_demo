...
THREE.GLTFLoader = (function () {
    ...
    GLTFMaterialsCommonExtension.prototype.extendParams = function (materialParams, material, parser) {
        ...
        switch (khrMaterial.type) {
            ...
            case 'commonBlinn':
            case 'commonPhong':
                keys.push('diffuseFactor', 'diffuseTexture', 'specularFactor', 'specularTexture',
                    'shininessFactor');
                break;
        ...
        if (materialValues.specularTexture !== undefined) {
            ...
            pending.push(parser.assignTexture(materialParams, 'specularMap', materialValues.specularTexture
                .index));
    ...
    function GLTFBinaryExtension(data) {
        ...
        while (chunkIndex < chunkView.byteLength) {
            ...
            if (chunkType === BINARY_EXTENSION_CHUNK_TYPES.JSON) {
                ...
                var contentArray = new Uint8Array(data, BINARY_EXTENSION_HEADER_LENGTH + chunkIndex,
                    chunkLength);
    ...
    function GLTFMaterialsPbrSpecularGlossinessExtension() {
        ...
        return {
            ...
            extendParams: function (params, material, parser) {
                ...
                params.glossiness = pbrSpecularGlossiness.glossinessFactor !== undefined ?
                ...
                if (uvScaleMap !== undefined) {
                    ...
                    if (uvScaleMap.matrix !== undefined) {
                        ...
                        if (uvScaleMap.matrixAutoUpdate === true) {
                            ...
                            uvScaleMap.matrix.setUvTransform(offset.x, offset.y, repeat.x, repeat.y,
    ...
    GLTFParser.prototype.loadAccessor = function (accessorIndex) {
        ...
        return Promise.all(pendingBufferViews).then(function (bufferViews) {
            ...
            if (byteStride && byteStride !== itemBytes) {
                ...
                bufferAttribute = new THREE.InterleavedBufferAttribute(ib, itemSize, accessorDef.byteOffset /
                    elementBytes, normalized);
                ...
                if (bufferView === null) {
                    ...
                    array = new TypedArray(bufferView, accessorDef.byteOffset, accessorDef.count *
                        itemSize);
            ...
            if (accessorDef.sparse !== undefined) {
                ...
                var sparseIndices = new TypedArrayIndices(bufferViews[1], byteOffsetIndices,
                    accessorDef.sparse.count * itemSizeIndices);
                var sparseValues = new TypedArray(bufferViews[2], byteOffsetValues, accessorDef.sparse
                    .count * itemSize);
    ...
    GLTFParser.prototype.loadTexture = function (textureIndex) {
        ...
        return Promise.resolve(sourceURI).then(function (sourceURI) {
            ...
            texture.format = textureDef.format !== undefined ? WEBGL_TEXTURE_FORMATS[textureDef.format] :
                THREE.RGBAFormat;

            if (textureDef.internalFormat !== undefined && texture.format !== WEBGL_TEXTURE_FORMATS[
                    textureDef.internalFormat]) {
            ...
            texture.type = textureDef.type !== undefined ? WEBGL_TEXTURE_DATATYPES[textureDef.type] :
    ...
    GLTFParser.prototype.loadMaterial = function (materialIndex) {
        ...
        if (materialExtensions[EXTENSIONS.KHR_MATERIALS_COMMON]) {
            ...
            materialParams.metalness = metallicRoughness.metallicFactor !== undefined ? metallicRoughness.metallicFactor :
                1.0;
            materialParams.roughness = metallicRoughness.roughnessFactor !== undefined ? metallicRoughness.roughnessFactor :
                1.0;
        ...
        if (alphaMode === ALPHA_MODES.BLEND) {
            ...
            if (alphaMode === ALPHA_MODES.MASK) {
                ...
                materialParams.alphaTest = materialDef.alphaCutoff !== undefined ? materialDef.alphaCutoff :
                    0.5;
            ...
            return scope.loadGeometries(primitives).then(function (geometries) {
                ...
                for (var i = 0, il = primitives.length; i < il; i++) {
                    ...
                    if (material.aoMap &&
                        ...
                        geometry.addAttribute('uv2', new THREE.BufferAttribute(geometry.attributes
                            .uv.array, 2));
                    ...
                    if (material.isGLTFSpecularGlossinessMaterial === true) {
                        ...
                        mesh.onBeforeRender = extensions[EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS]
                            .refreshUniforms;
    ...
    GLTFParser.prototype.loadCamera = function (cameraIndex) {
        ...
        if (cameraDef.type === 'perspective') {
            ...
            camera = new THREE.PerspectiveCamera(THREE.Math.radToDeg(xfov), aspectRatio, params.znear || 1,
                params.zfar || 2e6);

        } else if (cameraDef.type === 'orthographic') {

            camera = new THREE.OrthographicCamera(params.xmag / -2, params.xmag / 2, params.ymag / 2,
                params.ymag / -2, params.znear, params.zfar);
        ...
        return this.getMultiDependencies([
            ...
            for (var i = 0, il = animationDef.channels.length; i < il; i++) {
                ...
                if (sampler) {
                    ...
                    var input = animationDef.parameters !== undefined ? animationDef.parameters[
                        sampler.input] : sampler.input;
                    var output = animationDef.parameters !== undefined ? animationDef.parameters[
                    ...
                    if (node) {
                        ...
                        if (sampler.interpolation === 'CUBICSPLINE') {
                            ...
                            var outputAccessorValues = new TypedArray(outputAccessor.count *
                                itemSize / 3);
                            ...
                            for (var j = 0, jl = outputAccessor.count; j < jl; j += 3) {
                                ...
                                if (itemSize > 1) outputAccessorValues[j * itemSize / 3 + 1] =
                                    outputAccessor.getY(j + 1);
                                if (itemSize > 2) outputAccessorValues[j * itemSize / 3 + 2] =
                                    outputAccessor.getZ(j + 1);
                                if (itemSize > 3) outputAccessorValues[j * itemSize / 3 + 3] =
                                    outputAccessor.getW(j + 1);

                            }

                            outputAccessor = new THREE.BufferAttribute(outputAccessorValues,
                                itemSize / 3, outputAccessor.normalized);

                        }

                        var interpolation = sampler.interpolation !== undefined ? INTERPOLATION[
                            sampler.interpolation] : THREE.InterpolateLinear;
            ...
            var name = animationDef.name !== undefined ? animationDef.name : 'animation_' +
                animationIndex;
        ...
        return function loadScene(sceneIndex) {
            ...
            return this.getMultiDependencies([
                ...
                for (var i = 0, il = nodeIds.length; i < il; i++) {
                    ...
                    buildNodeHierachy(nodeIds[i], scene, json, dependencies.nodes, dependencies
                        .skins);
